...
Source page: https://atlassian.design/components/select/popup-select
...
Use popup select to let people filter through a list of actions where limited space is a concern for
the trigger.

**Example source:** [select-popup.tsx](../_source/examples/constellation/select-popup.tsx)
...
**Example source:** [select-popup-no-search.tsx](../_source/examples/constellation/select-popup-no-search.tsx)
...
**Example source:** [select-popup-checkbox.tsx](../_source/examples/constellation/select-popup-checkbox.tsx)
...
**Example source:** [select-popup-placement.tsx](../_source/examples/constellation/select-popup-placement.tsx)
...
together without extra effort. Use the `offset` and `preventOverflow` props from
[popper](https://atlaskit.atlassian.com/packages/design-system/popper) to keep them in view as a
stop-gap.

**Example source:** [select-popup-in-modal.tsx](../_source/examples/constellation/select-popup-in-modal.tsx)
...
By default, the PopupSelect content is rendered inside `React.Portal`. Use
`popperProps={{ strategy: 'fixed' }}` prop to render the content directly after the trigger element.

**Example source:** [select-popup-without-portal.tsx](../_source/examples/constellation/select-popup-without-portal.tsx)
