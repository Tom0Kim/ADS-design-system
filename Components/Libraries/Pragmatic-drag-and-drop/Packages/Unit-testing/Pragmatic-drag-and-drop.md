...
Source package: `@atlaskit/pragmatic-drag-and-drop-unit-testing@2.0.0`
...
The complete package changelog is preserved at [CHANGELOG.md](../../_package/unit-testing/CHANGELOG.md).
