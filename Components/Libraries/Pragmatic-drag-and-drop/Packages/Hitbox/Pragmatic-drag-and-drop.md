...
Source package: `@atlaskit/pragmatic-drag-and-drop-hitbox@2.0.0`
...
[as you can see in our tree example](https://atlassian.design/components/pragmatic-drag-and-drop/examples#tree).
...
purpose [`reorder` utility](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/utilities#reorder).
...
The complete package changelog is preserved at [CHANGELOG.md](../../_package/hitbox/CHANGELOG.md).
