...
The [core package](https://atlassian.design/components/pragmatic-drag-and-drop/core-package) does not enable accessible
controls automatically, as there is no one pattern that works well for all situations. Instead, use
these guidelines and our [optional packages](https://atlassian.design/components/pragmatic-drag-and-drop/optional-packages)
and [Design System components](https://atlassian.design/components) to create accessible experiences.
...
> **Note**
>
> Please refer to our [design guidelines](https://atlassian.design/components/pragmatic-drag-and-drop/design-guidelines) for
...
- If no **More button (...)** exists on a draggable entity, and movement outcomes are the only
  ...
  [drag handle menu button](https://atlassian.design/components/pragmatic-drag-and-drop/optional-packages/react-accessibility)
...
> Interactive example: `ActionMenuVariants`. See the original MDX under `_source`.
...
- [Drag handle menu component](https://atlassian.design/components/pragmatic-drag-and-drop/optional-packages/react-accessibility/drag-handle-button/about)
- [popup](https://atlassian.design/components/popup)
- [modal-dialog](https://atlassian.design/components/modal-dialog)
- [select](https://atlassian.design/components/select)

[Figma (Atlassians only)](https://go.atlassian.com/pdnd-01)
...
[accessibility guidelines](https://atlassian.design/foundations/accessibility#meaningful-text).
...
[live region package](https://atlassian.design/components/pragmatic-drag-and-drop/optional-packages/live-region).
...
> Interactive example: `ManualFocusRestorationExample`. See the original MDX under `_source`.

## Related

- [Atlassian drag and drop design guidelines](https://atlassian.design/components/pragmatic-drag-and-drop/design-guidelines)
- [Accessibility foundation general guidance](https://atlassian.design/foundations/accessibility#meaningful-text)
- [Drag handle menu component](https://atlassian.design/components/pragmatic-drag-and-drop/optional-packages/react-accessibility/drag-handle-button/about)
- [Live region package](https://atlassian.design/components/pragmatic-drag-and-drop/optional-packages/live-region)
