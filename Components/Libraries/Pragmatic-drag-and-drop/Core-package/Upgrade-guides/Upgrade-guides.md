...
1. [element adapter](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/adapters/element) → handling
   the dragging of draggable elements
2. [text selection adapter](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/adapters/text-selection)
   **(new)** → handling the dragging of text selections
3. [external adapter](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/adapters/external) **(new)**
...
[_external adapter_](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/adapters/external).
...
**Old:**
[`@atlaskit/pragmatic-drag-and-drop-react-beautiful-dnd-autoscroll`](https://atlassian.design/components/pragmatic-drag-and-drop/optional-packages/react-beautiful-dnd-autoscroll)

(previously called `@atlaskit/pragmatic-drag-and-drop-autoscroll`)

**New:**
[`@atlaskit/pragmatic-drag-and-drop-auto-scroll`](https://atlassian.design/components/pragmatic-drag-and-drop/optional-packages/auto-scroll)
