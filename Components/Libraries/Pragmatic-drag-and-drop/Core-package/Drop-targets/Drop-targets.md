...
> Interactive example: `NestedDropTargetExample`. See the original MDX under `_source`.
...
- `getIsSticky()` - whether the drop target will hold onto selection after no longer being dragged
  over
- [`onGenerateDragPreview`](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/events)
- [`onDragStart`](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/events)
- [`onDrag`](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/events)
- [`onDropTargetChange`](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/events)
- [`onDrop`](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/events)
...
[`once` utility function](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/utilities).
...
> [our cursor guide](https://atlassian.design/components/pragmatic-drag-and-drop/web-platform-design-constraints#cursors)
