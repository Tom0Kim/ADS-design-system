...
By default, [drop targets](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/drop-targets) will allow
any `draggable` to be dropped on it, and
[monitors](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/monitors) will listen to _all_ drag
operations.
...
> [`canDrop()`](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/drop-targets) function is called
> repeatedly throughout a drag operation, whereas the monitor
> [`canMonitor()`](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/monitors) function is only called
