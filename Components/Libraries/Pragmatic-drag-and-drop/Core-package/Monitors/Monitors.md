...
- `canMonitor?: (args: MonitorGetFeedbackArgs) => boolean`
...
[Learn more about event ordering](https://atlassian.design/components/pragmatic-drag-and-drop/core-package/events)
