...
export function usePanelManager() {
  var manager = usePanelActionsInternal();
  var state = usePanelStateInternal();
  return {
    state: state,
    manager: manager
  };
 ...
 * ```
 */
export var usePanelActions = usePanelActionsInternal;
 ...
 * ```
 */
export var usePanelState = usePanelStateInternal;