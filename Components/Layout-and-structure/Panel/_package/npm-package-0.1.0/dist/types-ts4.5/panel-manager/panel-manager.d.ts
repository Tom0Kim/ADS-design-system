 ...
 * ```
 */
export declare function usePanelManager(): {
 ...
 * ```
 */
export declare const usePanelActions: typeof usePanelActionsInternal;
/**
 ...
 * ```
 */
export declare const usePanelState: typeof usePanelStateInternal;
