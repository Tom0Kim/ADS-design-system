...
Source page: https://atlassian.design/components/eslint-plugin-design-system/consistent-css-prop-usage
...
- Styles should not be defined inline; it should instead be in a standalone variable.
  - The exception for this is style composition (e.g. ``),
...
`> Embedded documentation component: `Button` (see the original MDX under `_source`).`.
