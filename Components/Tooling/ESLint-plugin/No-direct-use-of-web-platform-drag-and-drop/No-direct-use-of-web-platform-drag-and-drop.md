...
Source page: https://atlassian.design/components/eslint-plugin-design-system/no-direct-use-of-web-platform-drag-and-drop
...
Adding drag related event listeners on our `` primitive.
