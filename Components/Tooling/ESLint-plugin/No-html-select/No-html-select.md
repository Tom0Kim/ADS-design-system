...
Source page: https://atlassian.design/components/eslint-plugin-design-system/no-html-select
...
Use one of the Atlassian Design System [Select](https://atlassian.design/components/select) components when suitable.
